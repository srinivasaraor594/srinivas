...
public class AdminAddEditDeletecomplaints extends TestBase {
	...
	@Test(priority = 3, dataProvider = "EditComplaints", dataProviderClass = Dataproviders.class, dependsOnMethods = {
			"AddComplaints" })
	...
	public void Results() {
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName + "Edited Complaint By AdminLogin",
				true);
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "List Of Complaints After Delete Added Complaint", true);
		Reporter.log(" ", true);
