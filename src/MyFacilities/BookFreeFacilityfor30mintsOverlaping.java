...
public class BookFreeFacilityfor30mintsOverlaping extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
					...
					if (BookingButton.equals("Book / Cancel")) {
						...
						try {
							...
							helper.TakeScreenShotOfWindowPopUp(
									"Booking Is allowed of Free Facility with Overlapping Timings");
							...
							helper.TakeScreenShotOfWindowPopUp(
									"Booking Is Not allowed of Free Facility with Overlapping Timings");
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Search For Free Facility To Check Overlapping", true);
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Booking Is Not allowed of Free Facility with Overlapping Timings", true);
		Reporter.log(" ", true);
