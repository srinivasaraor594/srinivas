...
public class SimulateOTHFacilityWithAdminLogin extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
		...
		Reporter.log(
				"ScriptName:Simulate OTH Facility with Admin Login - Book for 30 min (12:00 PM to 12:30 PM) - Charge should be 3000",
				true);
		Reporter.log("----------------------------------------------------------------------------", true);
		Reporter.log(" ", true);
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Simulation Of OTH Facility with Specified Timings With Admin Login", true);
		Reporter.log(" ", true);
