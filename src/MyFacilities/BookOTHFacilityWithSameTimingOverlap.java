...
public class BookOTHFacilityWithSameTimingOverlap extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
				...
				if (PriceDetailsButton.equals("Show")) {
					if (BookingButton.equals("Book / Cancel")) {
						...
						helper.TakeScreenShotOfWindowPopUp(
								"Popup Came After Booking OTHFacility of Same Timing OverLap  with  Admin Login");
						helper.DeepSleep();
						try {
							helper.ProcessAlert();
							helper.Sleep();
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Popup Came After Booking OTHFacility of Same Timing OverLap  with  Admin Login", true);
		Reporter.log(" ", true);
