...
public class CreatePaidFacilityOnlyForOthers extends TestBase {
	...
	public void AddFacility(String EnterFacilityName, String LinkParentFacility, String EnterContactPersonName,
		...
		Reporter.log(
				"Script Name:Admin---->Application--->MyFacilities--->Create one facility with PAID - Allowed for Booking - 1 hour Rs 3000 (Only for Others and link Owner Parent Facility) + Cancel Chrgs - Rs. 0",
				true);
		Reporter.log("----------------------------------------------", true);
		Reporter.log(" ", true);
		...
		helper.DeepSleep();
		Method6.AddFacilityForOthers(EnterFacilityName, LinkParentFacility, EnterContactPersonName, EnterContactNumber,
				RatesFor, FromTime, ToTime, EnterMinimumHours, EnterAmountForMinimumHours, EnterCancelCharges,
	...
	public void AddFacilityAfterDelete(String EnterFacilityName, String LinkParentFacility,
			String EnterContactPersonName, String EnterContactNumber, String RatesFor, String FromTime, String ToTime,
			String EnterMinimumHours, String EnterAmountForMinimumHours, String EnterCancelCharges,
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName + "EditPaidFacilityOnlyForOthers",
				true);
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName + "DeletedPaidFacilityOnlyForOthers",
				true);
