...
public class BookingFreeFacilityMoreThanAllowedTimeWithMemberLogin extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
		...
		Reporter.log("ScriptName:Member Login --> Book for 40 min (Eg: 9:31 AM to 10:11 AM) - More than allowed time",
				true);
		Reporter.log("----------------------------------------------------------------------------", true);
		Reporter.log(" ", true);
					...
					if (BookingButton.equals("Book / Cancel")) {
						...
						try {
							helper.TakeScreenShotOfWindowPopUp(
									"Booking Free Facility with MoreThan Allowed Timings With MemberLogin");
							helper.ProcessAlert();
							helper.DeepSleep();
							...
							helper.TakeScreenShotOfWindowPopUp(
									"Booking Is Not allowed of Free Facility with MoreThan Allowed Time With MemberLogin");
							Reporter.log(
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Search For Free Facility To Book MoreThan Allowed Time With MemberLogin", true);
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Booking Free Facility with MoreThan Allowed Timings With MemberLogin", true);
		Reporter.log(" ", true);
