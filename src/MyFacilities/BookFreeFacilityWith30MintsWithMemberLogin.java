...
public class BookFreeFacilityWith30MintsWithMemberLogin extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
				...
				if (PriceDetailsButton.equals("Free")) {
					if (BookingButton.equals("Book / Cancel")) {
						...
						helper.TakeScreenShotOfWindowPopUp(
								"PopupCameAfter saving details of Booking of Free Facility  For 30 mints slot With MemberLogin");
						helper.ProcessAlert();
						helper.Sleep();
					}
				}
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Search For FacilityWithFreeAnd Allow For Booking With MemberLogin", true);
		Reporter.log(
