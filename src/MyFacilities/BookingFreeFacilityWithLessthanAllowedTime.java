...
public class BookingFreeFacilityWithLessthanAllowedTime extends TestBase {
	...
	public void BookingFacility(String EnterFacilityNameToSearch, String EnterFromTime, String EnterToTime,
		...
		Reporter.log("ScriptName:Member Login --> Book for 10 min (Eg: 9:10 AM to 9:20 AM) - Less than allowed time",
				true);
		Reporter.log("----------------------------------------------------------------------------", true);
		Reporter.log(" ", true);
					...
					if (BookingButton.equals("Book / Cancel")) {
						...
						try {
							...
							helper.TakeScreenShotOfWindowPopUp(
									"Booking Is Not allowed of Free Facility with Lessthan Allowed Time");
							Reporter.log(
		...
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Search For Free Facility To Book Lessthan Allowed Time", true);
		Reporter.log("File Name : " + GlobalVariablesCalling.ScreenShotsFileName
				+ "Booking Free Facility with Lessthan Allowed Timings", true);
		Reporter.log(" ", true);
